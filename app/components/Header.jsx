    ...
    return (
        <div className='w-11/12 max-w-6xl text-center mx-auto flex flex-col items-center justify-center min-h-screen gap-4'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                <a href="#contact" className='px-10 py-3 border rounded-full border-white bg-black text-white flex items-center gap-2 dark:bg-transparent hover:bg-black/80 dark:hover:bg-darkHover duration-300'>
                    my linkedin
