      ...
      <div className='w-full h-fit flex flex-col items-center lg:items-start lg:flex-row gap-28 lg:gap-20 my-8 lg:my-20'>
        ...
        <div className='flex-1 space-y-10'>
            ...
            <div className='flex flex-col gap-3 justify-center items-center lg:items-start pt-5 lg:pt-0'>
              <p className='text-gray-500 dark:text-white/80'>Tools I use</p>
              <div className='flex gap-4'>
                {
                toolsData.map((tool, index) => (
                  <div key={index} className='flex-col items-center justify-center aspect-square border border-gray-300 p-3 rounded-md cursor-pointer hover:-translate-y-1.5 duration-300 dark:border-white/50 dark:bg-white/20'>
